...
class webServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            # Objective 3 (2) - Creating restaurants and new page
            ...
            if self.path.endswith("/restaurants"):
                ...
                output = ""
                # Objective 3 (1) : Creating a Link to create a new menu item
                ...
                for restaurant in restaurants:
                    ...
                    # Objective 4 : Replacing Edit href

                    output += "<a href ='/restaurants/%s/edit' >Edit </a> " % restaurant.id
                    output += "</br>"
                    # Objective 5 : Replacing Delete href
